...
## The numbers
    ...
    Custom voice setup    $500 one time
    Custom voice monthly  $100 a month on top of the $750

**$500 setup** covers what it actually costs: finding a local person, an hour of
recorded talking points, the clone, and the QA pass before it goes anywhere near a
customer. It is real labor, not a markup, and pricing it below the base $350 setup
would say the opposite.

**$100 a month, not $150.** Two reasons. The cloned voice bills at 1.5x against our
voice budget, so the marginal cost is real but it is a fraction of $750. And at $150
the upgrade is a fifth of the base price, which makes it read as a second product
rather than an add on. At $100 it reads as an upgrade, which is what it is and how it
should feel when a closer names it.
...
**The operational catch, and it is Lee's to accept or reject.** Bundling means
committing to ten voice clones, each needing a local person recruited and an hour
recorded, on top of ten concierge onboardings, in the same window. That is a real
...
For the demo page, after the standard voice sample:

    Want her to sound like someone from your own town?
...
This is the strongest part of the whole upgrade and it should not get lost in the
pricing. An owner in Spokane whose phone is answered by somebody who sounds like
Spokane is not buying a feature. Their customers hear a neighbor. That is worth more
to a junk removal company than any amount of polish, and it is the one thing a
national competitor structurally cannot do.
